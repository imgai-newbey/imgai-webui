        ...
        with gr.Tabs(elem_id="tabs_extensions") as tabs:
            ...
            with gr.TabItem("Available"):
                with gr.Row():
                    ...
                    available_extensions_index = gr.Text(value="https://raw.githubusercontent.com/wiki/imgai-newbey/imgai-webui/Extensions-index.md", label="Extension index URL").style(container=False)
